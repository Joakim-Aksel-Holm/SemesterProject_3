...
public class MachineControl_01
{

    private static MachineControl_01 _instance = new(1, "opc.tcp://127.0.0.1:4840");
    ...
    //Constructor 
    private MachineControl_01(int machineId, string machineUrl)
    {
        MachineId = machineId;
    ...
    public static MachineControl_01 Instance => _instance;
